...
public class ChessGUI extends Application implements EngineListener{
	//String startFen = "2p4B/2k1p3/8/8/2p2n2/R7/3Q1K2/8";
	/*TEST STRING 1*/String startFen = "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R";
	//String startFen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR";
	
	//Import and set up piece PNG's	
	Image wpI = new Image(getClass().getResource("/Images/wp.png").toExternalForm());
	Image bpI = new Image(getClass().getResource("/Images/bp.png").toExternalForm());
	Image wnI = new Image(getClass().getResource("/Images/wn.png").toExternalForm());
	Image bnI = new Image(getClass().getResource("/Images/bn.png").toExternalForm());
	Image wbI = new Image(getClass().getResource("/Images/wb.png").toExternalForm());
	Image bbI = new Image(getClass().getResource("/Images/bb.png").toExternalForm());
	Image wrI = new Image(getClass().getResource("/Images/wr.png").toExternalForm());
	Image brI = new Image(getClass().getResource("/Images/br.png").toExternalForm());
	Image wqI = new Image(getClass().getResource("/Images/wq.png").toExternalForm());
	Image bqI = new Image(getClass().getResource("/Images/bq.png").toExternalForm());
	Image wkI = new Image(getClass().getResource("/Images/wk.png").toExternalForm());
	Image bkI = new Image(getClass().getResource("/Images/bk.png").toExternalForm());	
	...
	public void handleMoveSelectionClick(long clickedSquare, Rectangle rectangle, boolean isLightSquare, long MoveBB, long CastleBB) {
		...
		if (game.getMoveGenerator().isOnBB(MoveBB, clickedSquare)) {
			...
			if (capturedPiece == 0b1000L) {
				EnPassant enPassant = new EnPassant(on, clickedSquare, selectedPiece, selectedPieceColour, false, 0);
			...
			//Checks if capture made.
				...
				if (selectedPiece == 0b1L & game.getMoveGenerator().isOnBB(clickedSquare, game.getMoveGenerator().getRank(7))) {
					PromotionCapture promotionCapture = new PromotionCapture(on, clickedSquare, selectedPiece, selectedPieceColour, false, 0, 0b110L, capturedPiece);
				...
				//If not promotion then regular capture is made.
					...
					Capture capture = new Capture(on, clickedSquare, selectedPiece, selectedPieceColour, false, 0, capturedPiece);
					movePieces(capture);
			...
			//Checks if non-capture promotion made.
				...
				Promotion promotion = new Promotion(on, clickedSquare, selectedPiece, selectedPieceColour, false, 0, 0b110L);
			...
			//If no special move condition is met then move made
				...
				Move move = new Move(on, clickedSquare, selectedPiece, selectedPieceColour, false, 0);
				movePieces(move);
				move.makeMove(board);
				game.setPlayersMoveMade(true);
				waitingForMoveSelection = false;
	...
	public void setPieces() {
		//Read FEN from Game
		squares = new StackPane[]{a8,b8,c8,d8,e8,f8,g8,h8,a7,b7,c7,d7,e7,f7,g7,h7,a6,b6,c6,d6,e6,f6,g6,h6,a5,b5,c5,d5,e5,f5,g5,h5,a4,b4,c4,d4,e4,f4,g4,h4,a3,b3,c3,d3,e3,f3,g3,h3,a2,b2,c2,d2,e2,f2,g2,h2,a1,b1,c1,d1,e1,f1,g1,h1};
		Scanner FENScanner = new Scanner(startFen);
	...
	public void movePieces(Move move) {
		...
		if (move instanceof Castle) {
			movePiecesCastle((Castle)move);
			return;
		}
		else if (move instanceof EnPassant) {
			movePiecesEnPassant((EnPassant)move);
			return;
		}
		squares = new StackPane[]{a8,b8,c8,d8,e8,f8,g8,h8,a7,b7,c7,d7,e7,f7,g7,h7,a6,b6,c6,d6,e6,f6,g6,h6,a5,b5,c5,d5,e5,f5,g5,h5,a4,b4,c4,d4,e4,f4,g4,h4,a3,b3,c3,d3,e3,f3,g3,h3,a2,b2,c2,d2,e2,f2,g2,h2,a1,b1,c1,d1,e1,f1,g1,h1};
		ImageView piecePNG;
